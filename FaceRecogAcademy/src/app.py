# -*- coding: utf-8 -*-
"""
Created on Firday Jun 14 2019,recreate june 2021
@author: Jiwitesh Kumar and ParagS
"""
import argparse
import logging
...
class RegistrationModule:
    def __init__(self, logFileName):
        ...
        self.window.title("Face Recognition and Tracking with ParagS")
        ...
        header = tk.Label(self.window, text="Employee Monitoring Registration --Paraggems1@gmail.com", width=80, height=2, fg="white", bg="#363e75",
...
# this module is responcible for differntaiting etween different faces
        ap = argparse.ArgumentParser()
    ...
    def trainModel(self):
        ...
        # ap = argparse.ArgumentParser()
        ap.add_argument("--embeddings", default="faceEmbeddingModels/embeddings.pickle",
                        help="path to serialized db of facial embeddings") #"embeddings.pickle" for holding face embedding
        ap.add_argument("--model", default="faceEmbeddingModels/my_model.h5",
                        help="path to output trained model") #"my_model.h5" for holding the seights of face
        ap.add_argument("--le", default="faceEmbeddingModels/le.pickle",
                        help="path to output label encoder") #"le.pickle" hold the labls of face
